...
{
    "distutils": {
        "name": "check_hz7_final",
        "sources": [
            "check_hz7_final.py"
        ]
    },
    "module_name": "check_hz7_final"
}
END: Cython Metadata */
...
#define __PYX_HAVE__check_hz7_final
#define __PYX_HAVE_API__check_hz7_final
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "check_hz7_final" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "check_hz7_final"
extern int __pyx_module_is_main_check_hz7_final;
int __pyx_module_is_main_check_hz7_final = 0;

/* Implementation of "check_hz7_final" */
...
#define __pyx_kp_u_KHNG_TM_THY_giao_dch_HZ7MB1SX_t __pyx_string_tab[2]
#define __pyx_kp_u_KIM_TRA_GIAO_DCH_HZ7MB1SX __pyx_string_tab[3]
#define __pyx_kp_u_M_GD __pyx_string_tab[4]
#define __pyx_kp_u_SELECT_FROM_transactions_WHERE_t __pyx_string_tab[5]
#define __pyx_kp_u_S_tin __pyx_string_tab[6]
#define __pyx_kp_u_TM_THY_GIAO_DCH __pyx_string_tab[7]
#define __pyx_kp_u_Trng_thi __pyx_string_tab[8]
#define __pyx_kp_u_User_ID __pyx_string_tab[9]
...
#define __pyx_n_u_conn __pyx_string_tab[16]
#define __pyx_n_u_connect __pyx_string_tab[17]
#define __pyx_n_u_cursor __pyx_string_tab[18]
#define __pyx_n_u_execute __pyx_string_tab[19]
#define __pyx_n_u_fetchone __pyx_string_tab[20]
...
#define __pyx_n_u_row __pyx_string_tab[26]
#define __pyx_n_u_setdefault __pyx_string_tab[27]
#define __pyx_n_u_sqlite3 __pyx_string_tab[28]
...
static int __pyx_pymod_exec_check_hz7_final(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_check_hz7_final},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_check_hz7_final(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_check_hz7_final(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_check_hz7_final(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'check_hz7_final' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "check_hz7_final" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_check_hz7_final", 0);
  ...
  if (__pyx_module_is_main_check_hz7_final) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "check_hz7_final")) {
      if (unlikely((PyDict_SetItemString(modules, "check_hz7_final", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
  ...
  /* "check_hz7_final.py":1
 * import sqlite3             # <<<<<<<<<<<<<<
 * 
 * print(' KIM TRA GIAO DCH HZ7MB1SX:')
*/
...
*/
  ...
  __pyx_t_4 = 1;
  {
    PyObject *__pyx_callargs[2] = {__pyx_t_3, __pyx_mstate_global->__pyx_kp_u_KIM_TRA_GIAO_DCH_HZ7MB1SX};
...
*/
    ...
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_5 = __Pyx_GetItemInt(__pyx_t_3, 4, long, 1, __Pyx_PyLong_From_long, 0, 0, 1, 1, __Pyx_ReferenceSharing_OwnStrongReference); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 17, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    ...
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __pyx_t_5 = __Pyx_PyUnicode_Concat(__pyx_mstate_global->__pyx_kp_u_Trng_thi, __pyx_t_3); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 17, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_4 = 1;
    {
    ...
    /* "check_hz7_final.py":18
 *     print(f'  S tin: {row[2]:,}')
 *     print(f'  Trng thi: {row[4]}')
 *     print(f'  M GD: {row[6]}')             # <<<<<<<<<<<<<<
 * else:
 *     print(' KHNG TM THY giao dch HZ7MB1SX trong database')
*/
    __pyx_t_5 = NULL;
    ...
    __Pyx_GOTREF(__pyx_t_6);
    __pyx_t_3 = __Pyx_GetItemInt(__pyx_t_6, 6, long, 1, __Pyx_PyLong_From_long, 0, 0, 1, 1, __Pyx_ReferenceSharing_OwnStrongReference); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 18, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    ...
    __Pyx_GOTREF(__pyx_t_6);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_3 = __Pyx_PyUnicode_Concat(__pyx_mstate_global->__pyx_kp_u_M_GD, __pyx_t_6); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 18, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    __pyx_t_4 = 1;
    {
...
*/
  /*else*/ {
    ...
    __pyx_t_4 = 1;
    {
      PyObject *__pyx_callargs[2] = {__pyx_t_3, __pyx_mstate_global->__pyx_kp_u_KHNG_TM_THY_giao_dch_HZ7MB1SX_t};
      __pyx_t_2 = __Pyx_PyObject_FastCall((PyObject*)__pyx_builtin_print, __pyx_callargs+__pyx_t_4, (2-__pyx_t_4) | (__pyx_t_4*__Pyx_PY_VECTORCALL_ARGUMENTS_OFFSET));
      __Pyx_XDECREF(__pyx_t_3); __pyx_t_3 = 0;
  ...
  /* "check_hz7_final.py":22
 *     print(' KHNG TM THY giao dch HZ7MB1SX trong database')
 * 
 * conn.close()             # <<<<<<<<<<<<<<
*/
  __pyx_t_3 = NULL;
  __Pyx_GetModuleGlobalName(__pyx_t_5, __pyx_mstate_global->__pyx_n_u_conn); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_mstate_global->__pyx_n_u_close); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_4 = 1;
  {
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init check_hz7_final", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init check_hz7_final");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 6; } index[] = {{40},{6},{58},{37},{10},{62},{15},{28},{17},{11},{1},{1},{15},{2},{18},{5},{4},{7},{6},{7},{8},{8},{10},{8},{5},{12},{3},{10},{7},{8}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (371 bytes) */
const char* const cstring = "BZh91AY&SY\374\301\273\210\000\000\"\337\375\300\000D\225(\222\277\357\236\364\277\357\376\3002\036$\006\254\000\000\030\014\0000\000@\0000\001\014\263b)\223$3H\001\241\243M\031\000h\003M\017H\302\000\000\212z\024\336\251\204\311\221\240\000\000\000\000\003C\020\000\032)\352OQ\243H\365=L4\214\006\243\r\r4\0020\000G\250\311\345\033\005\010\"\210\246a\034\026\001>\323\333qwM\014C0\255\240(\031\036\355\017*8\332\224\342\200\260\323@\355\023\230K:\247\333\032M\211e^\313\367\203E\3046\216\033\001O\301\340\274\006O\214k\\<WC!\002\030\232\350\342\364\005#\233\301\271\214dV\"6\214\001\346P\211\305c\324\203\246+!!\344E\227 \031\001\307\261\207\010R\002\205\344\200\340\372\207\003\220|\325\036n3d\252\"\202C~\233\356\224H\231\0320*\340\013\2503\304H\030\306\220,\001\002\312\001w\326\323l\254\230\030JX\274F9\0349\3019\301:\254\241\0063\002\221\002\005W\016\353(\003\306V|&\0201\333Iw\314\206\354\264\224R~\003\256\242\311\257\rAv\215\246f\271 \032\306^T}\030Pf_\350\3732\207\260\201;\247h\204i\021\230\214\200\24623\035\246\010\013\305\320*i\256\013\177\027rE8P\220\374\301\273\210";
...
const char* const cstring = "x\332\215O\315J\303@\020~\225\271\025D\004\361 \024\212\32466\245\306B\033\361\007a\331l\246\355b\272kw'\350U\301\213\266\207B\217\212\024}\212\346\030_$>\201\217\340V\251\324\233\003\303\3740\337\317T*\377\013\200f\275\014\037\317ch\371\371\354\250\001a>\016 \364\213\305\333\031\364%\327\020\027\331\243\030\200\177\276\033\354owO\201\214V}\2109\361\210[\374|\231M\240\325,\262;\207\352T\241\321\254\266\241^d\0175\377\027R\006\010\362Wh8\241\256w\350\325B\330\200\203N;pT\\Y.Hje\341\304\367:\336\372\212\t\035#T\240\264\342)\001t\213l\n$\213\354V9\327O\367\177\354\256i;\311\320\024\213\271sJ\203|.\335\014\307\026\315\367\267\233{+\367\027\221\246\2558z\237\212D*dR1\247/0\342\342R$\332\242\320J-\023\005\211\324Xm\360\006EJ\330C\022\003\355\020l\310\035\310\305P\307i\202\313N\361\241\253WF*bl\224\362\344ga\364\265E\212\261\307\323\204\354(\221\204;\214\021Zw\365\005\025\007\236\215";
...
const char* const bytes = "========================================  ID: \342\235\214 KH\303\224NG T\303\214M TH\341\272\244Y giao d\341\273\213ch HZ7MB1SX trong database\360\237\224\215 KI\341\273\202M TRA GIAO D\341\273\212CH HZ7MB1SX:  M\303\243 GD: SELECT * FROM transactions WHERE transaction_code = 'HZ7MB1SX'  S\341\273\221 ti\341\273\201n: \342\234\205 T\303\214M TH\341\272\244Y GIAO D\341\273\212CH:  Tr\341\272\241ng th\303\241i:   User ID: ,?database\\bot.db\304\221cline_in_tracebackcloseconnconnectcursorexecutefetchone__main____module____name__print__qualname__rowsetdefaultsqlite3__test__";
    PyObject *data = NULL;
