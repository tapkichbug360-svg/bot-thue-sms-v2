...
#define __PYX_HAVE__check_axnsqfo8
#define __PYX_HAVE_API__check_axnsqfo8
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "check_axnsqfo8" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "check_axnsqfo8"
extern int __pyx_module_is_main_check_axnsqfo8;
int __pyx_module_is_main_check_axnsqfo8 = 0;

/* Implementation of "check_axnsqfo8" */
...
#define __pyx_kp_u_KHNG_TM_THY_giao_dch_AXNSQFO8_t __pyx_string_tab[2]
#define __pyx_kp_u_KIM_TRA_GIAO_DCH_AXNSQFO8 __pyx_string_tab[3]
#define __pyx_kp_u_SELECT_FROM_transactions_WHERE_t __pyx_string_tab[4]
#define __pyx_kp_u_S_tin __pyx_string_tab[5]
#define __pyx_kp_u_TM_THY_GIAO_DCH __pyx_string_tab[6]
#define __pyx_kp_u_Trng_thi __pyx_string_tab[7]
#define __pyx_kp_u_User_ID __pyx_string_tab[8]
#define __pyx_kp_u__2 __pyx_string_tab[9]
#define __pyx_kp_u__4 __pyx_string_tab[10]
#define __pyx_kp_u_database_bot_db __pyx_string_tab[11]
...
#define __pyx_n_u_row __pyx_string_tab[25]
...
static int __pyx_pymod_exec_check_axnsqfo8(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_check_axnsqfo8},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_check_axnsqfo8(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_check_axnsqfo8(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_check_axnsqfo8(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'check_axnsqfo8' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "check_axnsqfo8" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_check_axnsqfo8", 0);
  ...
  if (__pyx_module_is_main_check_axnsqfo8) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "check_axnsqfo8")) {
      if (unlikely((PyDict_SetItemString(modules, "check_axnsqfo8", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
 ...
 * import sqlite3             # <<<<<<<<<<<<<<
 * 
 * print(' KIM TRA GIAO DCH AXNSQFO8:')
*/
...
*/
  ...
  __pyx_t_4 = 1;
  {
    PyObject *__pyx_callargs[2] = {__pyx_t_3, __pyx_mstate_global->__pyx_kp_u_KIM_TRA_GIAO_DCH_AXNSQFO8};
...
*/
    ...
    /* "check_axnsqfo8.py":17
 *     print(f'  User ID: {row[1]}')
 *     print(f'  S tin: {row[2]:,}')
 *     print(f'  Trng thi: {row[4]}')             # <<<<<<<<<<<<<<
 * else:
 *     print(' KHNG TM THY giao dch AXNSQFO8 trong database')
*/
    __pyx_t_6 = NULL;
...
*/
  /*else*/ {
    ...
    __pyx_t_4 = 1;
    {
      PyObject *__pyx_callargs[2] = {__pyx_t_5, __pyx_mstate_global->__pyx_kp_u_KHNG_TM_THY_giao_dch_AXNSQFO8_t};
      __pyx_t_2 = __Pyx_PyObject_FastCall((PyObject*)__pyx_builtin_print, __pyx_callargs+__pyx_t_4, (2-__pyx_t_4) | (__pyx_t_4*__Pyx_PY_VECTORCALL_ARGUMENTS_OFFSET));
      __Pyx_XDECREF(__pyx_t_5); __pyx_t_5 = 0;
  ...
  /* "check_axnsqfo8.py":21
 *     print(' KHNG TM THY giao dch AXNSQFO8 trong database')
 * 
 * conn.close()             # <<<<<<<<<<<<<<
*/
  __pyx_t_5 = NULL;
  __Pyx_GetModuleGlobalName(__pyx_t_6, __pyx_mstate_global->__pyx_n_u_conn); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 21, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_6, __pyx_mstate_global->__pyx_n_u_close); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 21, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_t_4 = 1;
  {
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init check_axnsqfo8", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init check_axnsqfo8");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 6; } index[] = {{40},{6},{58},{37},{62},{15},{28},{17},{11},{1},{1},{15},{2},{18},{5},{4},{7},{6},{7},{8},{8},{10},{8},{5},{12},{3},{10},{7},{8}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (360 bytes) */
const char* const cstring = "BZh91AY&SY\257\201\r\312\000\000\036\337\375\300\000D\225\010R\257\357\276\344\277\357\376\3002\036$\006\244\000\000\030\014\0000\000@\0000\001\006\306\r!OP\310\000z\201\2652\000i\240\000\003@\000\010\247\223SjM\224\304\321\352C&F\206 \031\003G\224\332\236\247\220\214\206\203I2\201\2042\006@\332\201\240\006\232\000\006\200\000\254\031\200\223\246\"\321m\3254\"\313\257\226'\007\316\331\033z\317\247\016vO\305\306\0274(\354\226\265M,\252\255\244\320\341\260Km\333A-\231\361.\000@M\327\243\274Ix\301\321\202\375\260\340HA\204j\341\372<\262\025\300\371Lh\230U\td\230d\300\t\005\334&\221\n\306\t9\034\317\235D\020Q\002\376{\301\357\360\260|2\254&\t\3310Le]\222\357\323$\026E\360YN\351\374\337\0255W(\205\3004\031T\210cl\256\214@\200\313\000\237^\266\245\215\213\002\024\342\032\220\224\212\nuq\270U\014fdQ\013\310\0060\271T\306`\253p\340~#\033\222\274\332\310\345\313i\351\022\275Jm\206-\260,\016A\221\261\250$\030\346)S\3511\004Eg\310\354b\357\350cG\264z\372?#\351~ \032\017\270\342\320)r\360'\352\246\025\374]\311\024\341BB\276\0047(";
    PyObject *data = __Pyx_DecompressString(cstring, 360, 2);
...
const char* const cstring = "x\332\215\217\317KBA\020\307\377\225\271\t\021]\272\304\003\t\321\247OL%}QA\260\354\3337\352\322s7w\347Q\327\202.e\007\301c\021B\177\205\357h\377\310\366\027\364'\264\026\206\335\032\030\346\007\363\231\371N\271\374?\003h\326\002\370x\231B+Z\315;\r\210W\3236\304\221[\276\235\303Pr\r\251+\036\305\010*g\235\376q\275{\000d\264\032B\312\211'\334\342\347\353\374\tZMW\334y\252W\201F\263\322\205\232+\036\252\321/\022\364\303\243\260\032\303\016\324{\335\266_\300\225\345\202\244V\026N\243\260\027n\267\230\320)B\031J\033\272\004\320w\305\014H\272\342Vy\255\317\367\177Dn]\014\000b\343\226\013\257\217F\253\205\3645\234X4\337?\356\036n4_$\232\366\322\344}&2\251\220I\305\374}\201\t\027\227\"\323\026\205Vj\355(H\344\306j\2037(r\302\001\222\030iO\2601\367\220\267\261N\363\014\327\231\342c\037\257\214T\304\330$\347\331O\303\350k\213\224\342\200\347\031\331I&\t\367\031#\264~\352\013/\210\233\321";
    ...
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #else /* compression: none (419 bytes) */
const char* const bytes = "========================================  ID: \342\235\214 KH\303\224NG T\303\214M TH\341\272\244Y giao d\341\273\213ch AXNSQFO8 trong database\360\237\224\215 KI\341\273\202M TRA GIAO D\341\273\212CH AXNSQFO8:SELECT * FROM transactions WHERE transaction_code = 'AXNSQFO8'  S\341\273\221 ti\341\273\201n: \342\234\205 T\303\214M TH\341\272\244Y GIAO D\341\273\212CH:  Tr\341\272\241ng th\303\241i:   User ID: ,?database\\bot.db\304\221cline_in_tracebackcloseconnconnectcursorexecutefetchone__main____module____name__print__qualname__rowsetdefaultsqlite3__test__";
    PyObject *data = NULL;
